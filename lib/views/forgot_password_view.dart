...
import 'package:flutter_bloc_vandad/utilities/dialogs/password_reset_email_sent_dialog.dart';
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Column(
            children: [
              const Text(
                  'If your forgot your password, simply enter your email and we will send you a password'),
              TextField(
